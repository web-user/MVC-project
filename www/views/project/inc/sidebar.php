				...
				<form action="#" id="my-form" method="post">
					<div class="modal-body">
						<div class="form-group">
							<label for="loginauth" class="control-label">Логин:</label>
							<input type="text" class="form-control" name="loginauth" id="loginauth" placeholder="login">
						</div>
						<div class="form-group">
							<label for="passauth" class="control-label">Пароль:</label>
	...
	<div class="widget">
		<div class="avtoriz useravtor">
			<?php if(!$_SESSION['auth']['user']): ?>
				<a type="button" data-toggle="modal" data-target="#exampleModal" data-whatever="@fat">Вход</a>
				<hr class="hr-reg">
				<p>
					<a href="?view=reg">Регестрацмя</a>
				</p>
			<?php else: ?>
				<p><span>Добро пожаловать,</span> <?php echo htmlspecialchars($_SESSION['auth']['user']); ?></p>
